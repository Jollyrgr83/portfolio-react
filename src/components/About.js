    ...
    <div>
      ...
      <section className="section-container mx-auto">
        <p className="section-text">
          ...
          programming and problem-solving. Originally born and raised in Iowa, I
          am a Navy veteran who has spent a large portion of my life on nuclear
          submarines.
        </p>
        <p className="section-text">
      ...
      <section className="section-container mx-auto">
        ...
        />
        <div className="ed-text-container mx-auto">
          <h3>University of Utah</h3>
          <h4>Full Stack Flex Certificate</h4>
          <p className="ed-text">
            html, css, javascript, bootstrap, jQuery, node.js, mongoDB, express,
            react
          </p>
        </div>
      </section>
      <section className="section-container mx-auto">
        <img src={aImage} className="ed mx-auto" alt="auburn university logo" />
        <div className="ed-text-container mx-auto">
